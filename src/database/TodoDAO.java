...
public class TodoDAO {
	...
	private static final String CREATE_TODO_SQL = "INSERT INTO todos (description) VALUES (?)";
	private static final String CREATE_TODO_DUE_SQL = "INSERT INTO todos (description, dueDate) VALUES (?, ?)";
	private static final String ASSIGN_TODO_SQL = "INSERT INTO user_todos (idAccount, idTodo) VALUES (?, ?)";
	private static final String GET_TODOS_SQL = "SELECT todos.idTodo, todos.description, todos.dueDate FROM user_todos "
			+ "JOIN todos ON user_todos.idTodo = todos.idTodo WHERE user_todos.idAccount = ?";
	private static final String DELETE_TODO_LINKS_SQL = "DELETE FROM user_todos WHERE idTodo = ?";
	private static final String DELETE_TODO_SQL = "DELETE FROM todos WHERE idTodo = ?";
